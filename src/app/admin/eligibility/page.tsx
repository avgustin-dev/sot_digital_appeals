      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-500">
            {isKy
              ? "Категориялар жана варианттар — жарандар «Жазылуу» шагында көрөт. Баш тартуу тексттери да ушул жерде."
              : "Категории и варианты, которые видит гражданин на шаге «Допуск». Тексты отказа редактируются здесь же."}
          </p>
        </div>
